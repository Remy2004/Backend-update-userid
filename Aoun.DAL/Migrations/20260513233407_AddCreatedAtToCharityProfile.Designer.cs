...
namespace Aoun.DAL.Migrations
{
    ...
    [Migration("20260513233407_AddCreatedAtToCharityProfile")]
    partial class AddCreatedAtToCharityProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aoun.DAL.Entities.Auth.CharityDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aoun.DAL.Entities.Favorite", b =>
                {
                    ...
                    b.HasIndex("UserId", "CaseId", "CampaignId")
                        .IsUnique()
                        .HasFilter("[CaseId] IS NOT NULL AND [CampaignId] IS NOT NULL");
